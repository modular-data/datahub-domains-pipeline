...
module "setup-dms-endpoints" {
  source = "git::https://github.com/ministryofjustice/digital-prison-reporting-domain-modules.git//modules/domains/dms-endpoints?ref=main"
...
# checkov:skip=CKV_TF_1: Commit hash not enforced for legacy module
module "dms-instance" {
  source = "git::https://github.com/ministryofjustice/digital-prison-reporting-domain-modules.git//modules/domains/dms-instance?ref=main"
...
# checkov:skip=CKV_TF_1: Commit hash not enforced for legacy module
module "dms-task" {
  source = "git::https://github.com/ministryofjustice/digital-prison-reporting-domain-modules.git//modules/domains/dms-task?ref=main"
...
# checkov:skip=CKV_TF_1: Commit hash not enforced for legacy module
module "lambda-setup" {
  source                                    = "git::https://github.com/ministryofjustice/digital-prison-reporting-domain-modules.git//modules/domains/pipeline-lambda?ref=main"
...
module "postgres-tickle-lambda" {
  source = "git::https://github.com/ministryofjustice/digital-prison-reporting-domain-modules.git//modules/domains/postgres-tickle-lambda?ref=main"
...
module "reconciliation-jobs" {
  source = "git::https://github.com/ministryofjustice/digital-prison-reporting-domain-modules.git//modules/domains/reconciliation-job?ref=main"
...
module "ingestion-jobs" {
  ...
  source                           = "git::https://github.com/ministryofjustice/digital-prison-reporting-domain-modules.git//modules/domains/ingestion-jobs?ref=main"
...
module "ingestion-pipeline" {
  source = "git::https://github.com/ministryofjustice/digital-prison-reporting-domain-modules.git//modules/domains/ingestion-pipeline?ref=main"
...
module "reload-pipeline" {
  source = "git::https://github.com/ministryofjustice/digital-prison-reporting-domain-modules.git//modules/domains/reload-pipeline?ref=main"
...
module "replay-pipeline" {
  source = "git::https://github.com/ministryofjustice/digital-prison-reporting-domain-modules.git//modules/domains/replay-pipeline?ref=main"
...
module "cdc-start-pipeline" {
  source = "git::https://github.com/ministryofjustice/digital-prison-reporting-domain-modules.git//modules/domains/start-cdc-pipeline?ref=main"
...
module "cdc-stop-pipeline" {
  source = "git::https://github.com/ministryofjustice/digital-prison-reporting-domain-modules.git//modules/domains/stop-cdc-pipeline?ref=main"
...
module "maintenance-pipeline" {
  source = "git::https://github.com/ministryofjustice/digital-prison-reporting-domain-modules.git//modules/domains/maintenance-pipeline?ref=main"
...
module "pipeline-start-triggers" {
  source = "git::https://github.com/ministryofjustice/digital-prison-reporting-domain-modules.git//modules/eventbridge_trigger?ref=main"
...
module "landing_zone_antivirus_check_lambda" {
  source = "git::https://github.com/ministryofjustice/digital-prison-reporting-domain-modules.git//modules/domains/antivirus-check-lambda?ref=main"
...
module "landing_zone_processing_lambda" {
  source = "git::https://github.com/ministryofjustice/digital-prison-reporting-domain-modules.git//modules/domains/landing-zone-processing-lambda?ref=main"
